...
export const images = {
  ...
  // BEFORE / AFTER — full-frame clean barrel tiles in even light; the BEFORE
  // layer gets a weathered CSS filter at render time, so the slider shows the
  // same roof grimy vs. clean and the trick reads believably.
  beforeAfterRoof: {
