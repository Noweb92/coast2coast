...
export const business = {
  ...
  shortDescription:
    "Roof repairs, cleaning, restoration and gutter services across Western Australia — from Perth to the Pilbara.",
  longDescription:
    "Coast2Coast Roofing is Western Australia's premium roofing specialist. We deliver roof repairs, high-pressure cleaning, full restorations and gutter services with precision craftsmanship. Licensed, insured and available 24/7 for emergencies — coast to coast, north to south.",
  foundedYear: 2009,

  // ── Contact (TODO: replace all placeholders with real details) ──
  phoneDisplay: "0400 000 000", // TODO
  phoneE164: "+61400000000", // TODO — international format for tel: links
  email: "info@coast2coastroofing.com.au", // TODO
  emergencyPhoneDisplay: "0400 000 000", // TODO — 24/7 line (can equal main)
  emergencyPhoneE164: "+61400000000", // TODO
...
export const services = [
  {
    ...
    features: ["Leak detection & repair", "Storm damage restoration", "Tile & metal roof fixes", "Emergency callouts 24/7"],
  },
  {
    id: "cleaning",
    icon: "Droplets",
    ...
    features: ["High-pressure washing", "Moss & lichen removal", "Gutter flush included", "Eco-friendly products"],
  },
  {
    id: "restoration",
    icon: "Home",
  ...
  },
  {
    ...
    desc: "Clean gutters, guard installation, downpipe repairs. Year-round water protection.",
    features: ["Gutter cleaning", "Guard installation", "Downpipe repairs", "Leaf protection systems"],
  },
];
...
export const testimonials = [
  ...
  { name: "Mark Davidson", location: "Joondalup", rating: 5, text: "Emergency leak repair on a Sunday. Actually answered the phone and had someone out within hours. Absolute legends." },
];
...
export const faqs = [
  { q: "How quickly can you get to my property?", a: "For emergencies, we can typically be on-site within 2-4 hours in the Perth metro area. For standard inspections, we book within 1-3 business days. Regional WA jobs are scheduled based on location — we'll give you an exact timeline." },
...
export const projects = [
  { title: "Full roof restoration", loc: "Perth CBD", tag: "Restoration", image: "restoration1", desc: "Complete strip, re-bed, re-point, seal and re-coat of a 280m² concrete tile roof. Included gutter replacement and downpipe repair." },
  { title: "Emergency storm repair", loc: "Mandurah", tag: "Repair", image: "repair1", desc: "Emergency callout after severe storm damage. Replaced 45 broken tiles, re-sealed flashing, and waterproofed the affected area within 24 hours." },
  { title: "High-pressure clean", loc: "Joondalup", tag: "Cleaning", image: "cleaning1", desc: "Full high-pressure clean of a 200m² Colorbond roof plus all gutters. Removed 8 years of built-up moss, lichen and debris." },
  { title: "Gutter guard install", loc: "Bunbury", tag: "Gutters", image: "gutters1", desc: "Complete gutter guard installation across a 320m² home. Aluminium mesh guards on all gutters plus leaf diverters on all downpipes." },
  { title: "Terracotta tile repair", loc: "Fremantle", tag: "Repair", image: "repair2", desc: "Replaced 60+ cracked terracotta tiles, re-bedded and re-pointed all ridge caps. Full inspection report provided with 12-month guarantee." },
  { title: "Colorbond re-coat", loc: "Rockingham", tag: "Restoration", image: "restoration2", desc: "Full clean, prime and re-coat in Colorbond Surfmist. Rust treatment on all fasteners. 10-year coating warranty." },
];
...
export const trustBadges = [
  ...
  { icon: "Users", title: "Locally Owned", desc: "WA family business since 2009" },
  { icon: "Star", title: "5.0 Google Rating", desc: "100+ verified five-star reviews" },
  { icon: "Clock", title: "24/7 Available", desc: "Emergency service around the clock" },
];
